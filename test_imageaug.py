...
seq = iaa.Sequential([
    ...
    iaa.SomeOf((0, 5),[
        ...
        # iaa.Dropout((0.1, 0.5), per_channel=False),   # 丢弃像素
        # iaa.Cutout(nb_iterations=(1, 11), size=0.1, squared=False, fill_mode="constant", cval=0), # 生成遮挡
...
idx = '02'
path = '/root/autodl-fs/sun_temp/datasets/civitai_imgs/'
saved_path = '/root/autodl-fs/sun_temp/datasets/civitai_imgs_output/'
imglist=[]
